    ...
    <section className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1">
                        ...
                        <div className="absolute bottom-0 w-full lg:p-11 p-5">
                            <div className="bg-white rounded-lg p-6 block">
                                ...
                                <a href="javascript:;" className="flex items-center mb-6">
                                    ...
                                    <h5 className="text-black text-base font-normal leading-6 ml-5">support@spinflame.com</h5>
                                </a>
                                <a href="javascript:;" className="flex items-center">
                                    ...
                                    <h5 className="text-black text-base font-normal leading-6 ml-5">Siliguri, West Bengal, India - 000000</h5>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="bg-gray-50 dark:bg-transparent p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
